...
public class FrequentTester {
	public static void main(String args[]){
		...
		String filename = "10^8_z_20.txt";
		String output_filename = "Sticky_Output_10^8_z_20_s5.txt";
		String output_all_filename = "Sticky_Output_all_10^8_z_20_s5.txt";
		String output_memory_filename = "Sticky_Output_memory_10^8_z_20_s5.txt";
		String output_time_filename = "Sticky_Output_time_10^8_z_20_s5.txt";
		String output_max_filename = "Sticky_Output_max_10^8_z_20_s5.txt";
		
		double support = 0.00001;
		long num_of_items = 100000000;

		Sticky ss = new Sticky(support, 0.1*support, 0.1);
		...
		try(BufferedReader br = new BufferedReader(new FileReader(filename))){ 
		    ...
		    // output f >= (support - epsilon) * num_of_items
		    for (Object item: items) {
		    	if ((int) items_value.toArray()[count] >= num_of_items*(0.9*support)) {
