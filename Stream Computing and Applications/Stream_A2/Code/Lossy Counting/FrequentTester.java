...
public class FrequentTester {
	...
	public static void main(String args[]){ 
		...
		String output_filename = "Lossy_Output_10^8_z_20_s5.txt";
		String output_all_filename = "Lossy_Output_all_10^8_z_20_s5.txt";
		String output_memory_filename = "Lossy_Output_memory_10^8_z_20_s5.txt";
		String output_time_filename = "Lossy_Output_time_10^8_z_20_s5.txt";
		String output_max_filename = "Lossy_Output_max_10^8_z_20_s5.txt";

		double support = 0.00001;
		long num_of_items = 100000000;
		
		Lossy ss = new Lossy(support, 0.1*support);
