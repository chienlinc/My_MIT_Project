	...
	private void initialize() {
		...
		btnSaveAs.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				fileChooser.setDialogTitle("Saving file as");
				...
				int panelX = (int) panel.getLocationOnScreen().getX();
				int panelY = (int) panel.getLocationOnScreen().getY();
				int panelWidth = panel.getWidth();
				int panelHeight = panel.getHeight();
				
				Rectangle screen = new Rectangle(panelX, panelY, panelWidth, panelHeight);				
				Robot robot = null;
				...
				BufferedImage bgimg = robot.createScreenCapture(screen);
				System.out.println(bgimg);
				
				try {
					ImageIO.write(bgimg, "jpg", new File(fileChooser.getCurrentDirectory()+"/"+filename));
		...
		gbc_btnSaveAs.insets = new Insets(0, 0, 5, 5);
		gbc_btnSaveAs.gridx = 3;
